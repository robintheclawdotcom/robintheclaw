...
BEGIN
    FOR constraint_record IN
        ...
        WHERE conrelid IN (
          ...
          AND contype = 'c'
          AND pg_get_constraintdef(oid) LIKE '%4d89928827e929a1991f3d47d31acf6a609ed9a9f84212b7ab780e3daecf8e0a%'
    LOOP
        EXECUTE format(
...
SET strategy_manifest_sha256 = 'da181add4750de3e3bc58606f6e0c1c2686a0206cc3f56ac3f0ba0c8f5c2868f',
    updated_at = now()
WHERE account.strategy_manifest_sha256 = '4d89928827e929a1991f3d47d31acf6a609ed9a9f84212b7ab780e3daecf8e0a'
  AND NOT EXISTS (
      SELECT 1
...
WHERE account.agent_id = agent.id
  AND account.strategy_manifest_sha256 = '4d89928827e929a1991f3d47d31acf6a609ed9a9f84212b7ab780e3daecf8e0a'
  AND agent.status <> 'closed';

UPDATE execution_accounts
SET status = 'blocked', updated_at = now()
WHERE strategy_manifest_sha256 = '4d89928827e929a1991f3d47d31acf6a609ed9a9f84212b7ab780e3daecf8e0a'
  AND status <> 'closed';
...
ALTER TABLE execution_accounts
    ADD CONSTRAINT execution_accounts_strategy_manifest_v2 CHECK (
        strategy_manifest_sha256 = 'da181add4750de3e3bc58606f6e0c1c2686a0206cc3f56ac3f0ba0c8f5c2868f'
        OR (
...
ALTER TABLE coordinator_account_registrations
    ADD CONSTRAINT coordinator_registrations_strategy_manifest_v2 CHECK (
        strategy_manifest_sha256 = 'da181add4750de3e3bc58606f6e0c1c2686a0206cc3f56ac3f0ba0c8f5c2868f'
        OR (
            strategy_manifest_sha256 = '4d89928827e929a1991f3d47d31acf6a609ed9a9f84212b7ab780e3daecf8e0a'
            AND status = 'blocked'
