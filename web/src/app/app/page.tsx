...
import { AgentButton, LiveExecutionPanel } from "../../components/strategy-controls";
...
export default function OverviewPage() {
  ...
  return (
    <>
      ...
      {isLive && <LiveExecutionPanel dashboard={dashboard} />}
      {!isLive && <section className="metric-grid" aria-label="Account balances">
        ...
        <section className="panel strategy-summary">
          ...
          {dashboard.agent ? (
            <>
              ...
              <dl className="detail-list"><div><dt>Mode</dt><dd>{dashboard.agent.mode === "live" ? "Live" : "Paper"}</dd></div>{!isLive && <><div><dt>Evaluations</dt><dd>{dashboard.agent.evaluations}</dd></div><div><dt>Candidates</dt><dd>{dashboard.agent.candidates}</dd></div></>}</dl>
            </>
      ...
      {!isLive && <section className="panel positions-panel">
      ...
      {!isLive && <section className="panel">
